...
Desenvolvedor focado em Backend com Python e estudante de Ciência da Computação.

## Perfil Profissional
* Graduando em Ciência da Computação, com foco em fundamentos teóricos e matemática aplicada.
* Especialização em desenvolvimento Backend utilizando Python e o framework Django.
* Experiência em ambiente Linux (Ubuntu) para desenvolvimento e gestão de ambientes.
* Desenvolvimento de aplicações modernas com TypeScript e integração de sistemas.
...
* **Twitter Clone:** Desenvolvimento de rede social utilizando TypeScript para gestão de dados e interface.
